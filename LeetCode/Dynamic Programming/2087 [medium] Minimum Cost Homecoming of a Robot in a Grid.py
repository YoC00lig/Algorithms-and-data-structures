...
# a robot is at the cell (startrow, startcol). You are also given an integer array homePos
# where homePos = [homerow, homecol] indicates that its home is at the cell (homerow, homecol).
