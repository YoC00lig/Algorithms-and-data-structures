...
def KRUSKAL(G):
    ...
    # tworzymy tablicÍ krawÍdzi V^2 (w listach sĻsiedztwa dodajemy tylko gdy i > j, mamy E <= V^2)
    E = []
    for i in range(V):
        for j in range(i):
            if G[i][j] > 0:
    ...
    #tworzymy tablicÍ do wyniku i wstawiamy do niej elementy. E * logarytm iterowany z E
    A = []
    for e in E:
