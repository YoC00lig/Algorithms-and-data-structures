# Zadanie 4. (mnożenie macierzy) Dany jest cięg macierzy A1,A2,...,An.
# Ktoś chce policzyć iloczyn A1A2⋯An. Macierze nie sa koniecznie kwadratowe
# (ale oczywiście znamy ich rozmiary). Zależnie w jakiej kolejnosci wykonujemy
# mnożenia, koszt obliczeniowy moze byc różny—należy podać algorytm znajdujący
